...
placeholder += "\n"
placeholder += "findNode(ID|TITLE|TYPE) => Node\n"
placeholder += "findNodes(ID|TITLE|TYPE) => Node[]\n"
placeholder += "createNode(TYPE, { key: value, ... }) => Node\n"
placeholder += "connectNodes(OUTPUT_NODE, INPUT_NODE, OUTPUT_SLOT_NAME?, INPUT_SLOT_NAME?)\n"
...
placeholder += "\n"
placeholder += "bypass(...Node[])\n"
placeholder += "unbypass(...Node[])\n"
placeholder += "pin(...Node[])\n"
placeholder += "unpin(...Node[])\n"
